						...
						<div class="pp_content_container"> \
							...
							<div class="pp_right"> \
								<div class="pp_content"> \
									...
									<div class="pp_fade"> \
										<a href="#" class="pp_expand" title="Originalgr&ouml;sse">Expand</a> \
										<div class="pp_hoverContainer"> \
											<a class="pp_next" href="#" title="Weiter">next</a> \
											<a class="pp_previous" href="#" title="Zur&uuml;ck">previous</a> \
										</div> \
										<div id="pp_full_res"></div> \
										<div class="pp_details"> \
											<div class="pp_nav"> \
												<a href="#" class="pp_arrow_previous" title="Zur&uuml;ck">Previous</a> \
												<p class="currentTextHolder">0/0</p> \
												<a href="#" class="pp_arrow_next" title="Weiter">Next</a> \
											</div> \
											<p class="pp_description"></p> \
											<div class="pp_social">{pp_social}</div> \
											<a class="pp_close" href="#" title="Schliessen">Close</a> \
										</div> \
									</div> \
								</div> \
							</div> \
		...
		*/
		...
		function _build_overlay(caller){
			...
			if(settings.slideshow){
				$pp_pic_holder.find('.pp_nav').prepend('<a href="#" class="pp_play" title="Slideshow">Play</a>')
