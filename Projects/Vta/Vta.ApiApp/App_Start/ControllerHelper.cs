...
namespace Vta.ApiApp
{
    public class ControllerHelper
    {
        ...
        public void SetViewBagValues(dynamic ViewBag)
        {
            ViewBag.CourseId = this.CoursesSelectList;
            ViewBag.LevelId = this.LevelsSelectList;
            ViewBag.ContentId = this.ContentsSelectList;
            ViewBag.QuestionId = this.QuestionsSelectList;
            ViewBag.OrderBy = this.OrderBySelectList;
            ViewBag.IsAscending = this.IsAscendingSelectList;
